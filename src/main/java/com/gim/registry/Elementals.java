...
public enum Elementals {
    ...
    DENDRO("gim.dendro", Effects.DENDRO, Attributes.dendro_bonus, Attributes.dendro_resistance, null, null, ChatFormatting.DARK_GREEN),
    ANEMO("gim.anemo", Effects.ANEMO, Attributes.anemo_bonus, Attributes.anemo_resistance, null, null, ChatFormatting.WHITE),
    GEO("gim.geo", Effects.GEO, Attributes.geo_bonus, Attributes.geo_resistance, null, null, ChatFormatting.GOLD),
    SUPERCONDUCT("gim.superconduct", Effects.DEFENCE_DEBUFF, Attributes.cryo_bonus, Attributes.cryo_resistance, DamageSource::bypassArmor, null, ChatFormatting.LIGHT_PURPLE),
